...
wire   [31:0] add_ln108_fu_98_p2;
reg   [31:0] add_ln108_reg_115;
reg   [30:0] i_fu_40;
wire   [30:0] add_ln106_fu_87_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln106_fu_81_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln106_fu_81_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln106_fu_87_p2 = (ap_sig_allocacmp_i_load + 31'd1);

assign add_ln108_fu_98_p2 = (in2_stream_dout + in1_stream_dout);
...
assign icmp_ln106_fu_81_p2 = (($signed(i_cast_fu_77_p1) < $signed(size_load)) ? 1'b1 : 1'b0);

assign in1_stream_read = in1_stream_read_local;

assign in2_stream_read = in2_stream_read_local;

assign out_stream_din = add_ln108_reg_115;
