...
attribute shreg_extract : string;
    ...
    signal trunc_ln114_1_reg_130 : STD_LOGIC_VECTOR (61 downto 0);
    ...
    signal zext_ln114_fu_121_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal size_read_local : STD_LOGIC;
    signal out_r_read_local : STD_LOGIC;
    signal icmp_ln114_fu_83_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln114_fu_89_p1 : STD_LOGIC_VECTOR (30 downto 0);
...
begin
    ...
    port map (
        ...
        sext_ln114 => trunc_ln114_1_reg_130,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_boolean_0 = ap_block_state1))) then
                ...
                trunc_ln114_1_reg_130 <= out_r_dout(63 downto 2);
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem0_AWREADY, m_axi_gmem0_BVALID, ap_CS_fsm_state2, ap_CS_fsm_state72, ap_block_state1, grp_store_result_Pipeline_mem_wr_fu_73_ap_done, ap_CS_fsm_state4)
    begin
        case ap_CS_fsm is
    ...
    empty_fu_103_p3 <= 
        trunc_ln114_fu_89_p1 when (icmp_ln114_fu_83_p2(0) = '1') else 
        ap_const_lv31_0;
    ...
    icmp_ln114_fu_83_p2 <= "1" when (signed(size_dout) > signed(ap_const_lv32_0)) else "0";
    ...
    begin
        if (((m_axi_gmem0_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_gmem0_AWLEN <= zext_ln114_fu_121_p1(32 - 1 downto 0);
        elsif (((ap_const_logic_1 = ap_CS_fsm_state4) or (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            m_axi_gmem0_AWLEN <= grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWLEN;
        else 
    ...
    begin
        ...
        sext_ln114_fu_111_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln114_1_reg_130),64));
    ...
    trunc_ln114_fu_89_p1 <= size_dout(31 - 1 downto 0);
    zext_ln114_fu_121_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(empty_reg_136),64));
end behav;
