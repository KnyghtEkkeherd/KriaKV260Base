...
reg    ap_block_state1;
reg   [61:0] trunc_ln114_1_reg_130;
...
wire   [63:0] zext_ln114_fu_121_p1;
reg    size_read_local;
reg    out_r_read_local;
wire   [0:0] icmp_ln114_fu_83_p2;
wire   [30:0] trunc_ln114_fu_89_p1;
reg   [71:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        ...
        trunc_ln114_1_reg_130 <= {{out_r_dout[63:2]}};
    end
end
...
assign empty_fu_103_p3 = ((icmp_ln114_fu_83_p2[0:0] == 1'b1) ? trunc_ln114_fu_89_p1 : 31'd0);

assign grp_store_result_Pipeline_mem_wr_fu_73_ap_start = grp_store_result_Pipeline_mem_wr_fu_73_ap_start_reg;

assign icmp_ln114_fu_83_p2 = (($signed(size_dout) > $signed(32'd0)) ? 1'b1 : 1'b0);
...
assign sext_ln114_fu_111_p1 = $signed(trunc_ln114_1_reg_130);

assign size_read = size_read_local;

assign trunc_ln114_fu_89_p1 = size_dout[30:0];

assign zext_ln114_fu_121_p1 = empty_reg_136;
