...
attribute shreg_extract : string;
    ...
    signal trunc_ln93_2_reg_145 : STD_LOGIC_VECTOR (61 downto 0);
    signal zext_ln93_fu_131_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal icmp_ln93_fu_92_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln93_fu_98_p1 : STD_LOGIC_VECTOR (30 downto 0);
...
begin
    ...
    port map (
        ...
        size => size,
        sext_ln93 => trunc_ln93_2_reg_145,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (m_axi_gmem0_ARREADY = ap_const_logic_1))) then
                trunc_ln93_2_reg_145 <= in_r(63 downto 2);
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem0_ARREADY, ap_CS_fsm_state2, ap_block_state1, grp_load_input_Pipeline_mem_rd_fu_82_ap_done, ap_CS_fsm_state74)
    begin
        case ap_CS_fsm is
    ...
    empty_fu_102_p3 <= 
        trunc_ln93_fu_98_p1 when (icmp_ln93_fu_92_p2(0) = '1') else 
        ap_const_lv31_0;
    ...
    icmp_ln93_fu_92_p2 <= "1" when (signed(size) > signed(ap_const_lv32_0)) else "0";
    in1_stream_din <= grp_load_input_Pipeline_mem_rd_fu_82_in1_stream_din;
    ...
    m_axi_gmem0_ARADDR_assign_proc : process(m_axi_gmem0_ARREADY, ap_CS_fsm_state2, grp_load_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARADDR, ap_CS_fsm_state73, ap_CS_fsm_state74, sext_ln93_fu_120_p1)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (m_axi_gmem0_ARREADY = ap_const_logic_1))) then 
    ...
    m_axi_gmem0_ARLEN_assign_proc : process(m_axi_gmem0_ARREADY, ap_CS_fsm_state2, zext_ln93_fu_131_p1, grp_load_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARLEN, ap_CS_fsm_state73, ap_CS_fsm_state74)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (m_axi_gmem0_ARREADY = ap_const_logic_1))) then 
            m_axi_gmem0_ARLEN <= zext_ln93_fu_131_p1(32 - 1 downto 0);
        elsif (((ap_const_logic_1 = ap_CS_fsm_state74) or (ap_const_logic_1 = ap_CS_fsm_state73))) then 
            m_axi_gmem0_ARLEN <= grp_load_input_Pipeline_mem_rd_fu_82_m_axi_gmem0_ARLEN;
        else 
    ...
    trunc_ln93_fu_98_p1 <= size(31 - 1 downto 0);
    zext_ln93_fu_131_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(empty_reg_140),64));
end behav;
