# 0 "./hw/sdt/system-top.dts"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "./hw/sdt/system-top.dts"
/dts-v1/;
# 1 "./hw/sdt/zynqmp.dtsi" 1
# 15 "./hw/sdt/zynqmp.dtsi"
# 1 "./hw/sdt/include/dt-bindings/dma/xlnx-zynqmp-dpdma.h" 1
# 16 "./hw/sdt/zynqmp.dtsi" 2
# 1 "./hw/sdt/include/dt-bindings/gpio/gpio.h" 1
# 17 "./hw/sdt/zynqmp.dtsi" 2
# 1 "./hw/sdt/include/dt-bindings/power/xlnx-zynqmp-power.h" 1
# 18 "./hw/sdt/zynqmp.dtsi" 2
# 1 "./hw/sdt/include/dt-bindings/reset/xlnx-zynqmp-resets.h" 1
# 19 "./hw/sdt/zynqmp.dtsi" 2
...
# 3 "./hw/sdt/system-top.dts" 2
# 1 "./hw/sdt/zynqmp-clk-ccf.dtsi" 1
# 10 "./hw/sdt/zynqmp-clk-ccf.dtsi"
# 1 "./hw/sdt/include/dt-bindings/clock/xlnx-zynqmp-clk.h" 1
# 11 "./hw/sdt/zynqmp-clk-ccf.dtsi" 2
...
/ {
 amba_pl: amba_pl {
  ...
  axi_dma_0: axi_dma@80010000 {
   ...
   xlnx,c-sg-include-stscntrl-strm = <1>;
...
# 6 "./hw/sdt/system-top.dts" 2
/ {
 board = "kr260_som";
 compatible = "xlnx,kr260_som";
 device_id = "xck26";
 slrcount = <1>;
 ...
 cpus_a53: cpus-a53@0 {
  ...
  address-map = <0x0 0xf0000000 &amba 0x0 0xf0000000 0x0 0x10000000>,
         ...
         <0x0 0x80000000 &axi_intc_0 0x0 0x80000000 0x0 0x10000>,
 ...
 cpus_r5_0: cpus-r5@0 {
  ...
  address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
         ...
         <0x80000000 &axi_intc_0 0x80000000 0x10000>,
