...
(* CORE_GENERATION_INFO = "kria_bd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=kria_bd,x_ipVersion=1.00.a,x_ipLanguage=VERILOG}" *) (* HW_HANDOFF = "kria_bd.hwdef" *) 
module kria_bd
   ();
  ...
  kria_bd_proc_sys_reset_1_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  kria_bd_smartconnect_0_1 smartconnect_1
