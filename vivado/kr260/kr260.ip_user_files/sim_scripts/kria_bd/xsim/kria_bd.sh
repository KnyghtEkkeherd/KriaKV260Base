...
export RDI_DATADIR="/run/media/wiktork/Data/Vitis/2026.1/data"

# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_23 -L zynq_ultra_ps_e_vip_v1_0_23 -L smartconnect_v1_0 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_23 -L zynq_ultra_ps_e_vip_v1_0_23 -L proc_sys_reset_v5_0_17 -L axi_lite_ipif_v3_1_0 -L axi_intc_v4_1_23 -L smartconnect_v1_0 -L axi_register_slice_v2_1_37 -L axi_datamover_v5_1_38 -L axi_sg_v4_1_21 -L axi_dma_v7_1_38 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot kria_bd xil_defaultlib.kria_bd xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim kria_bd -key {Behavioral:sim_1:Functional:kria_bd} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_2d9b.protoinst" -protoinst "protoinst_files/bd_ed5a.protoinst" -protoinst "protoinst_files/kria_bd.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/run/media/wiktork/Data/Vitis/2026.1/data/xsim"
  fi
