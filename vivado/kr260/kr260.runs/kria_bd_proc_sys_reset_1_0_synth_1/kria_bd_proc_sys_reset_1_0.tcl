...
synth_design -top kria_bd_proc_sys_reset_1_0 -part xck26-sfvc784-2LV-c -incremental_mode off -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix kria_bd_proc_sys_reset_1_0_ kria_bd_proc_sys_reset_1_0.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ kria_bd_proc_sys_reset_1_0_stub.v
 lappend ipCachedFiles kria_bd_proc_sys_reset_1_0_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ kria_bd_proc_sys_reset_1_0_stub.vhdl
 lappend ipCachedFiles kria_bd_proc_sys_reset_1_0_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ kria_bd_proc_sys_reset_1_0_sim_netlist.v
 lappend ipCachedFiles kria_bd_proc_sys_reset_1_0_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ kria_bd_proc_sys_reset_1_0_sim_netlist.vhdl
 lappend ipCachedFiles kria_bd_proc_sys_reset_1_0_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp kria_bd_proc_sys_reset_1_0.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips kria_bd_proc_sys_reset_1_0]
 }
...
rename_ref -prefix_all kria_bd_proc_sys_reset_1_0_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef kria_bd_proc_sys_reset_1_0.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file kria_bd_proc_sys_reset_1_0_utilization_synth.rpt -pb kria_bd_proc_sys_reset_1_0_utilization_synth.pb"  } 
...
OPTRACE "kria_bd_proc_sys_reset_1_0_synth_1" END { }
